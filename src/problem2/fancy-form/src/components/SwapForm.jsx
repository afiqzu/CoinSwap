            ...
            <form onSubmit={handleSubmit}>
                <div className='amount-box'>
                    ...
                    <div style={{display: 'flex', alignItems: 'center'}}>
                        <TokenSelect name={inputCurrency} onClick={() => openTokenMenu("input")}/>
                    </div>

                </div>

                <SwapVert onClick={swapTokens} sx={{marginTop: "10px", cursor:'pointer', marginBottom: "10px"}}/>
                ...
                <div className='amount-box'>
                    ...
                    <div style={{display: 'flex', alignItems: 'center'}}>
                        <TokenSelect name={outputCurrency} onClick={() => openTokenMenu("output")}/>
